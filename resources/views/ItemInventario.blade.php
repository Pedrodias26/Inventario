...
@section('title', 'Itens do Inventário')

@section('content')
    <div class="container mt-4">
        <h2 class="mb-4">Itens do Inventário</h2>
                    ...
                    @foreach($itens as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('itens-inventario.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Tem certeza que deseja excluir este item?')">
                                    @csrf
                                    @method('DELETE')
